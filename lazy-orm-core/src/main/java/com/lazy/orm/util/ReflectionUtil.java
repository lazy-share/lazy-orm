...
import com.lazy.orm.type.JavaType;
...
public abstract class ReflectionUtil {
    ...
    public static Field getFieldByName(String fieldName, Class clazz) {
        if (clazz == null || !StringUtil.hasText(fieldName)) {
            return null;
        }
        Field field = null;
        try {
    ...
    public static Object getValueByFieldName(String fieldName, Class clazz, Object object) {
        if (!StringUtil.hasText(fieldName) || clazz == null) {
            return null;
        }
        Method method = getGetMethodByFieldName(fieldName, clazz);
        Object value = null;
    ...
    public static void setFieldValue(String fieldName, Object value, Object obj) {
        ...
        try {
            if (!StringUtil.hasText(fieldName) || obj == null || value == null) {
                return;
            }
    ...
    public static void main(String[] args) {
        System.out.println(new BigDecimal("100000.00"));
    }
